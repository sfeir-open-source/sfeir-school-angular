...
export class PeopleService {
  ...
  fetchOne(id: string): Observable<any> {
    return this.httpClient.get(this._backendURL.onePeople.replace(':id', id));
  }
  ...
  create(person): Observable<any> {
    return this.httpClient.post(this._backendURL.allPeople, person);
  }

  update(person: any): Observable<any> {
    return this.httpClient.put(this._backendURL.onePeople.replace(':id', person.id), person);
  }
}
