...
const PEOPLE_SERVICE = {
  getPersonDetails: vi.fn(() => of(null as People | null)),
...
describe('UpdatePersonComponent', () => {
  ...
  describe('#basics', () => {
    beforeEach(async () => {
      vi.spyOn(PEOPLE_SERVICE, 'getPersonDetails').mockReturnValue(of(null));
  ...
  describe('#ui', () => {
    beforeEach(async () => {
      vi.spyOn(PEOPLE_SERVICE, 'getPersonDetails').mockReturnValue(of(PERSON));
