...
import { ComponentFixture, DeferBlockState, fakeAsync, flush } from '@angular/core/testing';
...
describe('PeopleComponent', () => {
  ...
  describe('#list-view-mode', () => {
    ...
    test('should display the item list', async () => {
      const deferredBlocksFixture = (await componentFixture.getDeferBlocks())[0];
      await deferredBlocksFixture.render(DeferBlockState.Complete);
