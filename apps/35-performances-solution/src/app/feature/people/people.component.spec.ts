...
describe('PeopleComponent', () => {
  ...
  beforeEach(async () => {
    ...
    renderDeferBlockState = renderDeferBlock;
  });
  ...
  describe('#list-view-mode', () => {
    ...
    test('should display the item list', async () => {
      await renderDeferBlockState(DeferBlockState.Complete, 0);
  ...
  describe('#dialog', () => {
    ...
    test('should call the open method of the dialog service', async () => {
      vi.useFakeTimers();
      try {
        const spy = vi.spyOn(MAT_DIALOG, 'open').mockReturnValue({ afterClosed: () => EMPTY } as any);
